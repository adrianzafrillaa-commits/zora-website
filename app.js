...
var translations = {
  de: {
    ...
    /* HERO */
    "hero.eyebrow": "Intelligent Concierge für Hotels · Schweiz",
    "hero.h1.line1": "Ihre automatisierte Rezeption.",
    "hero.h1.line2": "Mehrsprachig. Konform.",
    ...
    "sol.c2.title": "Schweizer Compliance",
    ...
    "comp.mockup.th.date": "Datum",
    "comp.mockup.th.adults": "Erwachsene",
    "comp.mockup.th.kids": "Kinder",
    "comp.mockup.th.total": "Total",
    ...
    "plan.core.f6": "Bewertungsanfrage nach Check-out",
  ...
  en: {
    ...
    "hero.eyebrow": "Intelligent Concierge for Hotels · Switzerland",
    "hero.h1.line1": "Your automated front desk.",
    "hero.h1.line2": "Multilingual. Compliant.",
    ...
    "comp.mockup.th.date": "Date",
    "comp.mockup.th.adults": "Adults",
    "comp.mockup.th.kids": "Children",
    "comp.mockup.th.total": "Total",
    ...
    "plan.core.f6": "Review request after check-out",
  ...
  fr: {
    ...
    "nav.login": "Client Login",
    "nav.cta": "Commencer",
    "hero.eyebrow": "Intelligent Concierge pour Hôtels · Suisse",
    "hero.h1.line1": "Votre réception automatisée.",
    "hero.h1.line2": "Multilingue. Conforme.",
    ...
    "sol.c2.title": "Conformité suisse", "sol.c2.desc": "Taxe de séjour et HESTA générés automatiquement chaque mois.",
    ...
    "sol.c3.f3": "Capture et transmission des demandes", "sol.c3.f4": "Canal WhatsApp",
    ...
    "compliance.eyebrow": "Conformité suisse", "compliance.h2": "Conformité suisse — automatisée",
    ...
    "comp.mockup.th.date": "Date",
    "comp.mockup.th.adults": "Adultes",
    "comp.mockup.th.kids": "Enfants",
    "comp.mockup.th.total": "Total",
    ...
    "plan.core.f5": "Dashboard des réservations", "plan.core.f6": "Demande d'avis après le check-out", "plan.core.cta": "Commencer",
    ...
    "trust.1": "Données des clients jamais partagées",
    "trust.2": "Conforme à la nLPD & au RGPD",
  ...
  it: {
    "nav.solution": "Soluzione", "nav.features": "Funzionalità",
    "nav.compliance": "Conformità",
    "nav.pricing": "Prezzi", "nav.faq": "FAQ", "nav.login": "Client Login", "nav.cta": "Inizia ora",
    "hero.eyebrow": "Intelligent Concierge per Hotel · Svizzera",
    "hero.h1.line1": "La vostra reception automatizzata.", "hero.h1.line2": "Multilingue. Conforme.",
    ...
    "sol.c2.title": "Conformità svizzera", "sol.c2.desc": "Kurtaxe e HESTA generati automaticamente ogni mese.",
    ...
    "sol.c3.f3": "Acquisizione e inoltro richieste speciali", "sol.c3.f4": "Canale WhatsApp",
    ...
    "compliance.eyebrow": "Conformità svizzera", "compliance.h2": "Conformità svizzera — automatizzata",
    ...
    "comp.mockup.label": "Kurtaxe Maggio 2026",
    "comp.mockup.th.date": "Data",
    "comp.mockup.th.adults": "Adulti",
    "comp.mockup.th.kids": "Bambini",
    "comp.mockup.th.total": "Totale",
    "comp.mockup.footer": "Generato automaticamente da ZORA · Pronto per l'export",
    ...
    "plan.core.f5": "Dashboard prenotazioni", "plan.core.f6": "Richiesta di recensione dopo il check-out", "plan.core.cta": "Inizia ora",
    ...
    "trust.1": "I dati degli ospiti non vengono mai condivisi",
    "trust.2": "Conforme a nLPD e GDPR",
  ...
  es: {
    ...
    "nav.compliance": "Cumplimiento normativo",
    "nav.pricing": "Precios",
    "nav.faq": "FAQ",
    ...
    /* HERO */
    "hero.eyebrow": "Concierge inteligente para hoteles",
    "hero.h1.line1": "Su recepción automatizada.",
    "hero.h1.line2": "Multilingüe. Cumplimiento normativo.",
    "hero.sub": "ZORA se encarga de la comunicación con los huéspedes, las tasas de alojamiento y los reportes administrativos — para que su equipo pueda enfocarse en lo importante.",
    "hero.btn1": "Ver demo en vivo",
    "hero.btn2": "Agendar una llamada",
    "hero.note": "Configuración gratuita este mes — Sin contratos de permanencia",

    /* STATS */
    "stats.n1": "Multi",
    "stats.l1": "Concierge multilingüe",
    "stats.n2": "15–25h",
    "stats.l2": "Ahorro de tiempo estimado/mes",
    "stats.n3": "0",
    "stats.l3": "Instalación técnica necesaria",
    "stats.n4": "RGPD",
    "stats.l4": "Protección de datos según el RGPD y estándares europeos",

    /* PROBLEM */
    "problem.eyebrow": "El problema",
    "problem.h2": "Su recepción pierde horas — sabemos dónde.",
    "problem.p": "Los hoteles responden cientos de consultas repetitivas de huéspedes cada semana, siempre con las mismas preguntas: desayuno, WiFi, check-in, estacionamiento. A eso se suman las declaraciones fiscales mensuales, las tasas de alojamiento y los reportes estadísticos — horas que su equipo podría dedicar a tareas de mayor valor.",
    "pain.1": "Consultas repetitivas por correo",
    "pain.2": "Reportes fiscales manuales",
    "pain.3": "Barreras de idioma con los huéspedes",
    "pain.4": "Ingreso manual de datos en hojas de cálculo",
    "pain.5": "Se espera disponibilidad 24/7",

    /* SOLUTION */
    "solution.eyebrow": "La solución",
    "solution.h2": "Una sola plataforma para toda la comunicación con huéspedes",
    "solution.sub": "ZORA se integra en la operación de su hotel sin cambiar ningún sistema existente — y automatiza las tareas que le cuestan horas a su equipo cada día.",
    "sol.c1.title": "Automatización de correos",
    "sol.c1.desc": "Las reservas entrantes, las consultas frecuentes y los pedidos especiales se clasifican y se responden automáticamente.",
    "sol.c1.f1": "Correo de bienvenida al reservar",
    "sol.c1.f2": "Respuestas automáticas a preguntas frecuentes",
    "sol.c1.f3": "Upselling 24h antes del check-in",
    "sol.c1.f4": "Solicitud de reseña después del check-out",
    "sol.c2.title": "Cumplimiento normativo",
    "sol.c2.desc": "Reportes de tasas turísticas y estadísticas de alojamiento generados automáticamente cada mes — listos para presentar ante las autoridades correspondientes.",
    "sol.c2.f1": "Liquidación de tasas turísticas locales",
    "sol.c2.f2": "Reportes estadísticos para las autoridades de turismo",
    "sol.c2.f3": "Exportación a Excel, lista para presentar",
    "sol.c2.f4": "Sin ingreso manual de datos",
    "sol.c3.title": "Upselling y concierge",
    "sol.c3.desc": "El concierge con IA responde las preguntas de los huéspedes en su idioma y sugiere upgrades en el momento justo.",
    "sol.c3.f1": "Idioma del huésped detectado automáticamente",
    "sol.c3.f2": "Ofertas de upgrade antes del check-in",
    "sol.c3.f3": "Registro y derivación de pedidos especiales",
    "sol.c3.f4": "Canal de WhatsApp",

    /* HOW IT WORKS */
    "how.eyebrow": "Cómo funciona",
    "how.h2": "Listo para operar en poco tiempo — sin instalación técnica",
    "step.1.num": "01",
    "step.1.title": "Conectar",
    "step.1.desc": "Usted nos da acceso a la bandeja de Gmail de su hotel. Sin cambiar de PMS, sin necesidad de un departamento de TI.",
    "step.2.num": "02",
    "step.2.title": "Configurar",
    "step.2.desc": "Importamos la información de su hotel y adaptamos ZORA a su marca y su idioma.",
    "step.3.num": "03",
    "step.3.title": "Activar",
    "step.3.desc": "ZORA comienza a clasificar los correos entrantes y a generar borradores de respuesta para su revisión.",
    "step.4.num": "04",
    "step.4.title": "Aprobar",
    "step.4.desc": "Usted revisa y aprueba cada borrador — nada se envía sin su aprobación.",

    /* FEATURES */
    "features.eyebrow": "Funciones",
    "features.h2": "Todo lo que necesita un hotel moderno",
    "feat.1.title": "Concierge inteligente 24/7",
    "feat.1.desc": "El concierge con IA detecta automáticamente el idioma del huésped y responde en varios idiomas en cuestión de segundos.",
    "feat.2.title": "Automatización de correos",
    "feat.2.desc": "Correos de bienvenida, respuestas a preguntas frecuentes, upselling y solicitudes de reseña — redactados automáticamente, aprobados por usted.",
    "feat.3.title": "Gestión de tasas turísticas",
    "feat.3.desc": "Liquidación mensual de las tasas de alojamiento de su destino, generada automáticamente y lista para exportar.",
    "feat.4.title": "Reportes estadísticos",
    "feat.4.desc": "Estadísticas mensuales de alojamiento para las autoridades competentes, con formato listo para presentar.",
    "feat.5.title": "Tarjeta de huésped digital",
    "feat.5.desc": "Envío automático de la tarjeta de huésped con código QR por correo antes de la llegada.",
    "feat.6.title": "Concierge por WhatsApp",
    "feat.6.desc": "Canal de WhatsApp impulsado por IA para comunicación directa con los huéspedes en tiempo real.",
    "badge.soon": "Próximamente · Q3 2026",

    /* COMPLIANCE */
    "compliance.eyebrow": "Cumplimiento normativo",
    "compliance.h2": "Cumplimiento normativo — automatizado",
    "comp.k.title": "Tasas turísticas locales",
    "comp.k.1": "Liquidación mensual según la normativa local vigente",
    "comp.k.2": "Tarifa por adulto/noche calculada automáticamente según su destino",
    "comp.k.3": "Exenciones automáticas configurables (por ejemplo, menores de edad o residentes locales)",
    "comp.k.4": "Exportación a Excel para presentar dentro del plazo establecido",
    "comp.h.title": "Estadísticas de alojamiento",
    "comp.h.1": "Reporte mensual para las autoridades de estadística",
    "comp.h.2": "Llegadas y pernoctaciones por país de residencia",
    "comp.h.3": "Ingreso promedio por persona/noche",
    "comp.h.4": "Exportación lista para subir al portal oficial",
    "comp.mockup.label": "Liquidación de tasas turísticas · Mayo 2026",
    "comp.mockup.th.date": "Fecha",
    "comp.mockup.th.adults": "Adultos",
    "comp.mockup.th.kids": "Niños",
    "comp.mockup.th.total": "Total",
    "comp.mockup.footer": "Generado automáticamente por ZORA · Listo para exportar",

    /* DEMO */
    "demo.eyebrow": "Demo en vivo",
    "demo.h2": "Hable con un concierge de IA real",
    "demo.p": "Esto es exactamente lo que vivirán sus huéspedes. Pruébelo usted mismo — pregunte en español, inglés, alemán, francés o cualquier otro idioma.",
    "demo.f1": "Responde automáticamente en el idioma del huésped",
    "demo.f2": "Conoce todos los detalles del hotel",
    "demo.f3": "Disponible las 24 horas, los 7 días de la semana",
    "demo.f4": "Por correo: ofertas de upgrade personalizadas antes del check-in",
    "demo.f5": "Por correo: captura automática de los datos de la reserva",
    "demo.chat.hotel": "Hotel Zora",
    "demo.chat.sub": "Concierge virtual · 24h",
    "demo.chat.online": "En línea",
    "demo.chat.welcome": "Bienvenido al Hotel Zora. Soy su concierge virtual, disponible a toda hora.\n\n¿En qué puedo ayudarle?",
    "demo.q1": "¿Hora de check-in?",
    "demo.q2": "¿Desayuno incluido?",
    "demo.q3": "¿Hay estacionamiento?",
    "demo.q4": "Reservar habitación",
    "demo.placeholder": "Escriba su pregunta...",
    "demo.error": "Disculpe, hubo un problema técnico. Por favor, intente de nuevo.",

    /* WIDGET (floating ZORA chat) */
    "widget.label": "¿Preguntas sobre ZORA?",
    "widget.title": "Asistente ZORA",
    "widget.sub": "Preguntas sobre el producto · Respuesta en segundos",
    "widget.welcome": "Hola. Soy el asistente de ZORA. Pregúnteme qué hace ZORA, cuánto cuesta o cómo funciona la configuración.",
    "widget.placeholder": "Su pregunta sobre ZORA...",

    /* PRICING */
    "pricing.eyebrow": "Precios",
    "pricing.h2": "Precios simples y transparentes",
    "pricing.sub": "Sin contratos. Cancele cuando quiera. Configuración gratuita este mes.",
    "plan.core.name": "Core",
    "plan.core.setup": "Configuración inicial: precio a consultar",
    "plan.core.free": "Configuración incluida este mes",
    "plan.core.price": "Consultar precios",
    "plan.core.period": "plan mensual",
    "plan.core.f1": "Concierge de IA 24/7 (multilingüe)",
    "plan.core.f2": "Correo de bienvenida al reservar",
    "plan.core.f3": "Respuestas automáticas a preguntas frecuentes",
    "plan.core.f4": "Correo de upselling antes del check-in",
    "plan.core.f5": "Panel de reservas",
    "plan.core.f6": "Solicitud de reseña después del check-out",
    "plan.core.cta": "Comenzar ahora",
    "plan.elite.name": "Elite",
    "plan.elite.badge": "El más popular",
    "plan.elite.setup": "Configuración inicial: precio a consultar",
    "plan.elite.free": "Early adopters — configuración incluida",
    "plan.elite.price": "Consultar precios",
    "plan.elite.period": "plan mensual",
    "plan.elite.f1": "Todo lo del plan Core",
    "plan.elite.f2": "Automatización de tasas turísticas y estadísticas",
    "plan.elite.f3": "Tarjeta de huésped digital (envío de QR)",
    "plan.elite.f4": "Concierge de IA por WhatsApp",
    "plan.elite.f5": "Respuestas automáticas en Booking.com",
    "plan.elite.f6": "Soporte prioritario",
    "plan.elite.cta": "Comenzar ahora",
    "trust.1": "Los datos de los huéspedes nunca se comparten con terceros",
    "trust.2": "Cumple con el RGPD y las normativas de protección de datos",
    "trust.3": "Sin contratos de permanencia",
    "trust.4": "Transmisión de datos cifrada",

    /* FAQ */
    "faq.eyebrow": "FAQ",
    "faq.h2": "Preguntas frecuentes",
    "faq.q1": "¿Tengo que cambiar mi PMS o mi sistema de reservas?",
    "faq.a1": "No. ZORA trabaja en paralelo con su sistema actual. Solo necesitamos acceso a la bandeja de correo de su hotel — sin integración técnica, sin departamento de TI.",
    "faq.q2": "¿Qué tan seguros están los datos de mis huéspedes?",
    "faq.a2": "Todos los datos se almacenan en servidores europeos, se transmiten cifrados y nunca se comparten con terceros. ZORA cumple con el RGPD de la UE y altos estándares de protección de datos.",
    "faq.q3": "¿Cuánto tarda la configuración?",
    "faq.a3": "La configuración es rápida y no requiere ninguna instalación técnica. En cuanto usted nos da acceso a la cuenta de correo, nosotros configuramos ZORA por usted.",
    "faq.q4": "¿Puedo cancelar ZORA en cualquier momento?",
    "faq.a4": "Sí. Puede cancelar mes a mes, sin dar explicaciones. Sus datos se eliminan por completo en un plazo de 30 días.",
    "faq.q5": "¿Qué pasa si ZORA comete un error?",
    "faq.a5": "ZORA genera borradores — usted siempre mantiene el control final. Cada respuesta es revisada y aprobada por su equipo antes de enviarse. Nada sale del hotel sin su aprobación.",
    "faq.q6": "¿En qué idiomas funciona ZORA?",
    "faq.a6": "El concierge responde automáticamente en el idioma del huésped. Es multilingüe y cubre los idiomas europeos más comunes y muchos más.",
    "faq.q7": "¿Qué hoteles usan ZORA?",
    "faq.a7": "ZORA fue desarrollado específicamente para hoteles independientes de 3–5★. Actualmente estamos preparando los primeros proyectos piloto y esperamos sumar nuevas alianzas.",
    "faq.q8": "¿ZORA se integra con mi PMS?",
    "faq.a8": "La integración con PMS (por ejemplo Mews, Apaleo o Protel) está en nuestro roadmap. Si su PMS es prioritario para usted, contáctenos — le avisaremos en cuanto la integración esté disponible.",

    /* CONTACT */
    "contact.eyebrow": "Contacto",
    "contact.h2": "¿Listo para automatizar su hotel?",
    "contact.sub": "Agende una llamada de demo gratuita de 30 minutos. Le mostraremos exactamente cómo funciona ZORA para su hotel.",
    "form.name": "Su nombre",
    "form.hotel": "Nombre del hotel",
    "form.email": "Correo electrónico",
    "form.phone": "Número de teléfono",
    "form.message": "Cuéntenos sobre su hotel...",
    "form.privacy": "Acepto la <a href='/privacy.html'>política de privacidad</a>. Mis datos se usarán únicamente para responder a mi consulta.",
    "form.submit": "Enviar mensaje",

    /* FOOTER */
    "footer.tagline": "Concierge inteligente para hoteles",
    "footer.col.product": "Producto",
    "footer.col.company": "Empresa",
    "footer.col.legal": "Legal",
    "footer.product.1": "Solución",
    "footer.product.2": "Funciones",
    "footer.product.3": "Precios",
    "footer.product.4": "Demo en vivo",
    "footer.company.1": "Nosotros",
    "footer.company.2": "Contacto",
    "footer.company.3": "Carreras",
    "footer.legal.1": "Aviso legal",
    "footer.legal.2": "Privacidad",
    "footer.legal.3": "Términos y condiciones",
    "footer.legal.4": "Política de cookies",
    "footer.copy": "© 2026 ZORA — Adrián Zafrilla Ortiz · Kriens, Suiza",

    /* COOKIE */
    "cookie.text": "Usamos cookies para mejorar nuestro sitio web y ofrecerle la mejor experiencia. Conozca más en nuestra <a href='/privacy.html'>política de privacidad</a>.",
    "cookie.accept": "Aceptar todas",
    "cookie.necessary": "Solo las necesarias"
  }
};
