...
var translations = {
  de: {
    ...
    /* STATS */
    "stats.n1": "15+",
    "stats.l1": "Sprachen unterstützt",
    "stats.n2": "60–80h",
    "stats.l2": "Zeitersparnis pro Monat",
    "stats.n3": "48h",
    "stats.l3": "Von Anmeldung bis Aktivierung",
    "stats.n4": "100%",
    "stats.l4": "nDSG-konform",

    /* PROBLEM */
    "problem.eyebrow": "Das Problem",
    "problem.h2": "Ihre Rezeption verliert Stunden — wir wissen wo.",
    "problem.p": "Hotels in der Schweiz beantworten 200+ E-Mails pro Woche mit immer den gleichen Fragen: Frühstück, WiFi, Check-in, Parking. Dazu monatliche Steuermeldungen, Kurtaxe-Abrechnungen, HESTA-Berichte. Stunden, die Ihr Team auf wichtigere Aufgaben verwenden könnte.",
    ...
    "sol.c3.f1": "15+ Sprachen automatisch erkannt",
    ...
    "how.h2": "In 48 Stunden einsatzbereit",
    "step.1.num": "01",
    ...
    "step.4.desc": "Sie überprüfen die Entwürfe — oder konfigurieren ZORA für vollautomatisches Versenden.",

    /* FEATURES */
    "features.eyebrow": "Funktionen",
    "features.h2": "Alles, was ein modernes Hotel braucht",
    "feat.1.title": "24/7 Intelligent Concierge",
    "feat.1.desc": "Der KI-Concierge erkennt die Sprache des Gastes automatisch und antwortet sofort — in über 15 Sprachen.",
    "feat.2.title": "E-Mail-Automatisierung",
    "feat.2.desc": "Willkommens-E-Mails, FAQ-Antworten, Upselling und Review-Anfragen — vollständig automatisiert.",
    ...
    "demo.f4": "Bietet Upgrades und Extras gezielt an",
    "demo.f5": "Erfasst Buchungsdetails ohne Aufwand",
    ...
    "plan.core.f1": "24/7 KI-Concierge (15+ Sprachen)",
    ...
    "faq.a3": "48 Stunden ab dem Moment, in dem Sie uns Zugriff auf das E-Mail-Konto gewähren. Keine technische Installation erforderlich.",
    ...
    "faq.a5": "ZORA generiert Entwürfe — Sie behalten immer die finale Kontrolle. Nichts wird automatisch versendet ohne Ihre Freigabe, außer Sie konfigurieren es explizit so.",
    "faq.q6": "In welchen Sprachen funktioniert ZORA?",
    "faq.a6": "Der Concierge antwortet automatisch in der Sprache des Gastes — über 15 Sprachen werden unterstützt, einschließlich Deutsch, Französisch, Italienisch, Englisch, Spanisch, Mandarin und Arabisch.",
    "faq.q7": "Welche Hotels nutzen ZORA?",
    "faq.a7": "ZORA wurde speziell für 3–5★-Hotels in der Schweiz entwickelt. Wir arbeiten gerade mit ersten Piloten in Luzern zusammen und freuen uns auf weitere Partnerschaften.",
    "faq.q8": "Was kostet eine PMS-Integration?",
    "faq.a8": "Wenn Sie ein PMS wie Mews, Apaleo oder Protel nutzen, können wir auf Wunsch eine API-Integration einrichten. Kontaktieren Sie uns für ein individuelles Angebot.",
  ...
  en: {
    ...
    "stats.n1": "15+",
    "stats.l1": "Languages supported",
    "stats.n2": "60–80h",
    "stats.l2": "Time saved per month",
    "stats.n3": "48h",
    "stats.l3": "From signup to live",
    "stats.n4": "100%",
    "stats.l4": "nDSG compliant",

    "problem.eyebrow": "The Problem",
    "problem.h2": "Your front desk is losing hours — we know where.",
    "problem.p": "Hotels in Switzerland answer 200+ emails per week with the same questions: breakfast, WiFi, check-in, parking. Plus monthly tax filings, Kurtaxe reports, HESTA statistics — hours your team could spend on higher-value tasks.",
    ...
    "sol.c3.f1": "15+ languages detected automatically",
    ...
    "step.4.desc": "You review and send the drafts — or configure ZORA to send automatically.",

    "features.eyebrow": "Features",
    "features.h2": "Everything a modern hotel needs",
    "feat.1.title": "24/7 Intelligent Concierge",
    "feat.1.desc": "The AI concierge detects the guest's language automatically and responds instantly — in over 15 languages.",
    "feat.2.title": "Email Automation",
    "feat.2.desc": "Welcome emails, FAQ responses, upselling, and review requests — fully automated.",
    ...
    "demo.f4": "Suggests upgrades and extras at the right moment",
    "demo.f5": "Captures booking details effortlessly",
    "demo.chat.hotel": "Hotel Zora Luzern",
    ...
    "plan.core.f1": "24/7 AI Concierge (15+ languages)",
    ...
    "faq.a3": "48 hours from the moment you grant us access to the email account. No technical installation required.",
    ...
    "faq.a5": "ZORA generates drafts — you always retain final control. Nothing is sent automatically without your approval, unless you explicitly configure it that way.",
    "faq.q6": "What languages does ZORA support?",
    "faq.a6": "The concierge automatically responds in the guest's language — over 15 languages are supported, including German, French, Italian, English, Spanish, Mandarin, and Arabic.",
    "faq.q7": "Which hotels use ZORA?",
    "faq.a7": "ZORA was built specifically for 3–5★ hotels in Switzerland. We are currently working with early pilots in Luzern and look forward to further partnerships.",
    "faq.q8": "What does PMS integration cost?",
    "faq.a8": "If you use a PMS such as Mews, Apaleo, or Protel, we can set up an API integration on request. Contact us for an individual quote.",
  ...
  fr: {
    ...
    "stats.n1": "15+", "stats.l1": "Langues supportées",
    "stats.n2": "60–80h", "stats.l2": "Temps économisé par mois",
    "stats.n3": "48h", "stats.l3": "De l'inscription à l'activation",
    "stats.n4": "100%", "stats.l4": "Conforme nLPD",
    "problem.eyebrow": "Le Problème",
    "problem.h2": "Votre réception perd des heures — nous savons où.",
    "problem.p": "Les hôtels en Suisse répondent à 200+ e-mails par semaine avec toujours les mêmes questions. ZORA automatise ces tâches répétitives.",
    ...
    "sol.c3.f1": "15+ langues détectées automatiquement", "sol.c3.f2": "Offres de surclassement avant check-in",
    "sol.c3.f3": "Capture et transmission des demandes", "sol.c3.f4": "Canal WhatsApp (À venir T3 2026)",
    "how.eyebrow": "Comment ça marche", "how.h2": "Opérationnel en 48 heures",
    ...
    "step.4.num": "04", "step.4.title": "Valider", "step.4.desc": "Vous vérifiez les brouillons ou configurez l'envoi automatique.",
    "features.eyebrow": "Fonctionnalités", "features.h2": "Tout ce dont un hôtel moderne a besoin",
    "feat.1.title": "Concierge IA 24/7", "feat.1.desc": "Détecte la langue du client et répond instantanément en 15+ langues.",
    "feat.2.title": "Automatisation e-mail", "feat.2.desc": "E-mails de bienvenue, FAQ, upselling et avis — entièrement automatisés.",
    ...
    "demo.f4": "Propose des surclassements au bon moment",
    "demo.f5": "Capture les détails de réservation sans effort",
    ...
    "plan.core.f1": "Concierge IA 24/7 (15+ langues)", "plan.core.f2": "E-mail de bienvenue à la réservation",
    ...
    "faq.q3": "Combien de temps dure l'installation?", "faq.a3": "48 heures à partir du moment où vous nous donnez accès au compte e-mail.",
    ...
    "faq.q5": "Que se passe-t-il en cas d'erreur?", "faq.a5": "ZORA génère des brouillons — vous gardez toujours le contrôle final.",
    "faq.q6": "Quelles langues sont supportées?", "faq.a6": "Plus de 15 langues, dont l'allemand, le français, l'italien, l'anglais, l'espagnol, le mandarin et l'arabe.",
    "faq.q7": "Quels hôtels utilisent ZORA?", "faq.a7": "ZORA est conçu pour les hôtels 3–5★ en Suisse. Nous travaillons avec les premiers pilotes à Lucerne.",
    "faq.q8": "Quel est le coût d'intégration PMS?", "faq.a8": "Contactez-nous pour un devis personnalisé selon votre PMS.",
  ...
  it: {
    ...
    "stats.n1": "15+", "stats.l1": "Lingue supportate",
    "stats.n2": "60–80h", "stats.l2": "Tempo risparmiato al mese",
    "stats.n3": "48h", "stats.l3": "Dalla registrazione all'attivazione",
    "stats.n4": "100%", "stats.l4": "Conforme nLPD",
    "problem.eyebrow": "Il Problema", "problem.h2": "La vostra reception perde ore — sappiamo dove.",
    "problem.p": "Gli hotel in Svizzera rispondono a 200+ e-mail a settimana con le stesse domande. ZORA automatizza queste attività ripetitive.",
    ...
    "sol.c3.f1": "15+ lingue rilevate automaticamente", "sol.c3.f2": "Offerte di upgrade prima del check-in",
    "sol.c3.f3": "Acquisizione e inoltro richieste speciali", "sol.c3.f4": "Canale WhatsApp (In arrivo T3 2026)",
    "how.eyebrow": "Come funziona", "how.h2": "Operativo in 48 ore",
    ...
    "step.4.num": "04", "step.4.title": "Approvare", "step.4.desc": "Verificate le bozze o configurate l'invio automatico.",
    "features.eyebrow": "Funzionalità", "features.h2": "Tutto ciò di cui un hotel moderno ha bisogno",
    "feat.1.title": "Concierge IA 24/7", "feat.1.desc": "Rileva la lingua dell'ospite e risponde istantaneamente in oltre 15 lingue.",
    "feat.2.title": "Automazione e-mail", "feat.2.desc": "E-mail di benvenuto, FAQ, upselling e richieste di recensione — completamente automatizzati.",
    ...
    "demo.f4": "Propone upgrade al momento giusto",
    "demo.f5": "Acquisisce i dettagli di prenotazione senza sforzo",
    ...
    "plan.core.f1": "Concierge IA 24/7 (15+ lingue)", "plan.core.f2": "E-mail di benvenuto alla prenotazione",
    ...
    "faq.q3": "Quanto tempo richiede l'installazione?", "faq.a3": "48 ore dal momento in cui ci concedete l'accesso all'account e-mail.",
    ...
    "faq.q5": "Cosa succede se ZORA fa un errore?", "faq.a5": "ZORA genera bozze — mantenete sempre il controllo finale.",
    "faq.q6": "In quali lingue funziona ZORA?", "faq.a6": "Il concierge risponde automaticamente nella lingua dell'ospite — oltre 15 lingue supportate.",
    "faq.q7": "Quali hotel usano ZORA?", "faq.a7": "ZORA è stato sviluppato per hotel 3–5★ in Svizzera. Stiamo lavorando con i primi hotel pilota a Lucerna.",
    "faq.q8": "Quanto costa l'integrazione PMS?", "faq.a8": "Contattateci per un preventivo personalizzato.",
